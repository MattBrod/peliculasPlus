...
export class DetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service.getMovies(this.movie).subscribe((res) => {
      this.data = res;
      ...
      this.providersCall =
        ...
        this.data.id +
        this.service.providersUrl +
        this.service.apiKeyEs;

      this.service.getMovies(this.providersCall).subscribe((res) => {
        this.providers = res;
      ...
      this.videosInfo =
        ...
        this.service.detailUrl +
        this.data.id +
        this.service.videosUrl +
        this.service.apiKeyEs;

      this.service.getMovies(this.videosInfo).subscribe((res) => {
        this.videos = res;
        ...
        this.videos.results.forEach(
          (element: { type: string; key: string }) => {
